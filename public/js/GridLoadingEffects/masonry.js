...
function(t) {
    ...
    i.prototype._transition = function(t) {
        ...
        for (var o in i)
            n.push(o);
        var r = {};
        if (r.transitionProperty = n.join(","),
...
function(t) {
    ...
    function r(t, i) {
        if ("string" == typeof t && (t = l.querySelector(t)),
        !t || !_(t))
            return m && m.error("Bad " + this.settings.namespace + " element: " + t),
            void 0;
        this.element = t,
    ...
    r.prototype.bindResize = function() {
        this.isResizeBound || (f.bind(t, "resize", this),
